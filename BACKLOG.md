...
- [ ] Learning Loop v2 + dataset pipeline — `docs/LEARNING_LOOP.md`; needs Supabase URL + anon key (app) and a service-role key (server job). Owner to decide ordering vs the weather page — #60
