...
const styles = StyleSheet.create({
  ...
  note: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.textMuted, lineHeight: 18, marginTop: spacing.xs },
  narrative: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodyMd, color: colors.text, lineHeight: 21, marginBottom: spacing.sm },
  ...
  statValue: { fontFamily: fontFamily.archivo.extrabold, fontSize: fontSize.titleLg, fontWeight: fontWeight.bold, color: colors.accent },
  // "doors planned" / "claim-grade roofs" under the number — the mock's stat-label convention.
  statLabel: { ...dataLabel, color: colors.textMuted, marginTop: 2, textAlign: 'center' },
  ...
  ringValue: { fontFamily: fontFamily.archivo.extrabold, fontSize: fontSize.titleMd, fontWeight: fontWeight.bold, lineHeight: 22 },
  ringLabel: { ...dataLabel, fontSize: 9.5, color: colors.textMuted, marginTop: -2 },
  areaMain: { flex: 1, gap: 2 },
  areaTitleRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  rank: { fontFamily: fontFamily.mono, fontSize: fontSize.bodySm, fontWeight: fontWeight.bold, color: colors.textSubtle },
  areaTitle: { flexShrink: 1, fontFamily: fontFamily.archivo.bold, fontSize: fontSize.titleMd, fontWeight: fontWeight.bold, color: colors.navy },
  areaSub: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.textMuted },
  performance: { fontFamily: fontFamily.archivo.semibold, fontSize: fontSize.bodySm, color: colors.text, fontWeight: fontWeight.semibold },
  ...
  expectTitle: { fontFamily: fontFamily.archivo.bold, fontSize: fontSize.bodyLg, fontWeight: fontWeight.bold, color: colors.text },
  expectSub: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.textMuted, lineHeight: 18 },
  calNote: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.text, lineHeight: 18, marginTop: spacing.xs },
  housingLine: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.textMuted },
  rationale: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodyMd, color: colors.text, lineHeight: 21 },
  ...
  openerText: { flex: 1, fontFamily: fontFamily.archivo.medium, fontSize: fontSize.bodyMd, color: colors.text, lineHeight: 20, fontStyle: 'italic' },
  bullets: { gap: spacing.xs },
  bullet: { flexDirection: 'row', gap: spacing.sm },
  bulletDot: { color: colors.accent, fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodyMd, lineHeight: 20 },
  bulletText: { flex: 1, fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodyMd, color: colors.text, lineHeight: 20 },
  // "STATUS" — the mock's mono eyebrow convention.
  ...
  statusText: { fontFamily: fontFamily.archivo.semibold, fontSize: fontSize.bodyMd, fontWeight: fontWeight.semibold, color: colors.text },
  ...
  secondaryBtnText: { color: colors.navy, fontFamily: fontFamily.archivo.semibold, fontWeight: fontWeight.semibold, fontSize: fontSize.bodyMd },
  ...
  routeBtnText: { color: colors.textInverse, fontFamily: fontFamily.archivo.bold, fontWeight: fontWeight.bold, fontSize: fontSize.bodyMd },
  ...
  nearbyTitle: { fontFamily: fontFamily.archivo.semibold, fontSize: fontSize.bodyMd, fontWeight: fontWeight.semibold, color: colors.text },
  nearbySub: { fontFamily: fontFamily.archivo.regular, fontSize: fontSize.bodySm, color: colors.textMuted, lineHeight: 17 },
  ...
  nearbyAddr: { fontFamily: fontFamily.archivo.semibold, fontSize: fontSize.bodyMd, fontWeight: fontWeight.semibold, color: colors.text },
  ...
  homeBtnText: { fontFamily: fontFamily.archivo.semibold, fontSize: fontSize.bodySm, fontWeight: fontWeight.semibold, color: colors.text },
