...
--   5. Knocking data (migration 20260903140000_knocking_data.sql): sessions,
--      doors, plans, do-not-knock, profiles, app_admins, the owner's views,
--      the GeoJSON RPC, and the admin read policies.
-- ============================================================================
...
-- ============================================================================
-- 5. Knocking data — VERBATIM copy of
--    supabase/migrations/20260903140000_knocking_data.sql. Keep the two
--    identical (the migration is the one applied live; this copy exists so a
--    full schema.sql run provisions a fresh project in one paste).
-- ============================================================================
